...
apex-engine ships an MCP server (11 tools: apex_fanout / apex_synthesize / apex_decompose / apex_report / apex_self_check / apex_qa_review / apex_self_security_check / apex_code_review / apex_security_review / apex_history_search / apex_web_search). **Every apex-engine user should run the setup once.**
